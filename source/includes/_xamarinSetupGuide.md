...
Build your project and deploy your application on an Android device. For module-specific documentation, please check [this section](#modules) for more information. 
...
//TODO: Xamarin Forms, Troubleshooting, etc.


https://documentation.anyline.io/#modules

https://developer.xamarin.com/guides/android/getting_started/

Check out [this section] (#getting-started) for platform-specific information.
Generate your key <a href="http://portal.anyline.io/">in our portal</a>. 

To configure the look and behaviour of the scan view, simply provide a .json file in the Assets folder of your project and set the build action to AndroidAsset.
Alternatively, can also use xml attributes in the layout file.
...
The configuration of the scan views works like in the [Android Config] (#android-config)


Your personal license keys can be purchased in our [Anyline Store](https://www.anyline.io/store/) and 
Each key is bound to a specific application by the Bundle Identifier (iOS) or the ApplicationId (Android).
