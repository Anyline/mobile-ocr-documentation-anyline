...
Furthermore, Anyline is available as [Cordova Plugin] (#cordova-plugin).
...
- **PLUGIN_USAGE.md:**     quick start guide
...
Copy the <i>anylinesdk-plugin</i> folder and add the plugin to your cordova project. Make sure you have already added (at least on of) android/iOS platform to your project.
...
```
Add the following code to your (autogenerated) <i>config.xml</i> of your cordova-project, declaring the feature "AnylineSDK".
...
You can either reuse those simple scripts, or create your own, adapted to your needs. <br/>
...
Basically, there is one simple exec-call to the AnylineSDK, with the following parameter:
...
- <b>config</b>: an array
    ...
    * Example from MRZ: 
	``` ["YOUR_LICENSE_KEY", //replace with the license key 
...
```java
cordova.exec(onResult, onError, "AnylineSDK", "scanBarcode", ["YOUR_LICENSE_KEY", {
  "captureResolution": "720p",
...
```java
	cordova.exec(onResult, onError, "AnylineSDK", "scanElectricMeter", ["YOUR_LICENSE_KEY", {
	  "captureResolution": "720p",
...
```java
	cordova.exec(onResult, onError, "AnylineSDK", "scanMRZ", ["f16bd60a02efe73fa247033061977375", {
      "captureResolution": "1080p",
